from rag_app.schemas.message_schema import IChatResponse
from rag_app.utils.adaptive_cards.cards import create_adaptive_card, create_image_card
from rag_app.utils.chains import get_suggestions_questions
